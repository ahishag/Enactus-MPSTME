...
<h1 style="margin-top:100px;">Patched Products</h1>
<?php 
	$query = mysqli_query($connection,"select name, description from products where project = 'Patched'");
	while ($row = mysqli_fetch_assoc($query))
	{
		echo '<div class="card" style="float:left;margin-top:25px;width:100%;background-color:#fff">
<div style="float:left;height:200px;width:350px;"><center><img src="assets/img/Patched/'.$row['name'].'/'.$row['name'].'.jpg" height="200px"></center></div>
